...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      <input 
        type="range" 
        class="w-full bg-gray-200 accent-lime-400 hover:accent-lime-600"
        :min="MIN"
        :max="MAX"
        :step="STEP"
    ...
    <p v-else class="text-center text-xl text-gray-500">Añade una cantidad y un plazo a pagar</p>
  </div>
</template>
